...
const DynamicControl = wp.customize.Control.extend({
  ...
  initThimControl: function (control) {
    ...
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.doAction)('thim.dynamicControl.initThimControl', this); // Save the value
...
/* harmony default export */ __webpack_exports__["default"] = (DynamicControl);
...
const ColorComponent = props => {
  ...
  let PickerComponent; // We can't just render `pickerComponent` directly, we need these lines so that the compiler will import them.
...
/* harmony default export */ __webpack_exports__["default"] = (ThimDependencies);
...
const SelectControl = wp.customize.Control.extend({
  ...
  ready: function ready() {
    const control = this; // Re-render control when setting changes.
...
const SliderComponent = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (sliderRef.current) {
      ...
      const val = ((_sliderRef$current = sliderRef.current) === null || _sliderRef$current === void 0 ? void 0 : _sliderRef$current.value) || props.default;
...
/* harmony default export */ __webpack_exports__["default"] = (SwitchControl);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ ThimTooltips; }
/* harmony export */ });
function thimTooltipAdd(control) {
  Object.entries(thimCustomizerTooltips).forEach(function (_ref) {
    ...
    if (!target) return;
    target.classList.add('thim-tooltip-wrapper'); // Build the tooltip trigger.

    const trigger = '<span class="tooltip-trigger"><span class="dashicons dashicons-editor-help"></span></span>'; // Build the tooltip content.

    const content = '<span class="tooltip-content">' + tooltip.content + '</span>';
    const $target = jQuery(target); // Append the trigger & content next to the control's title.
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ TypographyControl; }
/* harmony export */ });
/* harmony import */ var _wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/hooks */ "@wordpress/hooks");
/* harmony import */ var _wordpress_hooks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__);
...
controlConstructor['thim-select'] = _select_control__WEBPACK_IMPORTED_MODULE_6__["default"]; // TypographyControl.
